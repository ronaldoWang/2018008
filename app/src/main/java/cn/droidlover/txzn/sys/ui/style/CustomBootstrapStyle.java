package cn.droidlover.txzn.sys.ui.style;
...
public class CustomBootstrapStyle implements BootstrapBrand {
    ...
    public CustomBootstrapStyle(Context context) {
        ...
        defaultTextColor = context.getResources().getColor(R.color.custom_font);
        ...
        activeTextColor = context.getResources().getColor(R.color.custom_font);
